...
{
	{ (char*)"data/BGM/title.wav", -1 },		// BGM
	{ (char*)"data/BGM/bgm2.wav", -1 },			// BGM2
	{ (char*)"data/BGM/game.wav", -1 },			// game
	{ (char*)"data/BGM/result.wav", 0 },		// result
	{ (char*)"data/SE/fire.wav", 0 },			// 火の音
	{ (char*)"data/SE/charge.wav", -1 },		// チャージ音
	{ (char*)"data/SE/explosion.wav", 0 },		// 貯め攻撃 火
	{ (char*)"data/SE/bubble.wav", 0 },			// 貯め攻撃 水
	{ (char*)"data/SE/wind.wav", 0 },			// 貯め攻撃 風
	{ (char*)"data/SE/thunder.wav", 0 },		// 貯め攻撃 雷
	{ (char*)"data/SE/kettei.wav", 0 },			// 決定音
	{ (char*)"data/SE/crick.wav", 0 },			// カーソル操作音
	{ (char*)"data/SE/pillar_down.wav", 0 },	// 柱が下がる時の音
	{ (char*)"data/SE/damage.wav", 0 },			// ダメージ音
	{ (char*)"data/SE/change.wav", 0 },			// プレイヤーチェンジ音
};
